$(function(){
  /*  $(".leftbar li:nth-child(1) a").click(function(){
        $(".dresses").show();
        $(".path h4:nth-child(3) a").text("Женские платья оптом в Кургане");
        $(".header h2").text("КУПИТЬ ПЛАТЬЯ ОПТОМ В КУРГАНЕ");
        $(".costums, .blouse, .skirt, .trousers, .jackets, .cardigans, .cloak, .overalls, .coat, .clothes").hide();
    });
    $(".leftbar li:nth-child(2) a").click(function(){
        $(".costums").show();
        $(".path h4:nth-child(3) a").text("Женские костюмы оптом в Кургане");
        $(".header h2").text("КУПИТЬ КОСТЮМЫ ОПТОМ В КУРГАНЕ");
        $(".dresses, .blouse, .skirt, .trousers, .jackets, .cardigans, .cloak, .overalls, .coat, .clothes").hide();
    });
     $(".leftbar li:nth-child(3) a").click(function(){
        $(".blouse").show();
        $(".path h4:nth-child(3) a").text("Женские блузки оптом в Кургане");
        $(".header h2").text("КУПИТЬ БЛУЗКИ ОПТОМ В КУРГАНЕ");
        $(".costums, .dresses, .skirt, .trousers, .jackets, .cardigans, .cloak, .overalls, .coat, .clothes").hide();
    });
     $(".leftbar li:nth-child(4) a").click(function(){
        $(".skirt").show();
        $(".path h4:nth-child(3) a").text("Женские юбки оптом в Кургане");
        $(".header h2").text("КУПИТЬ ЮБКИ ОПТОМ В КУРГАНЕ");
     ...
     $(".leftbar li:nth-child(5) a").click(function(){
        $(".trousers").show();
        $(".path h4:nth-child(3) a").text("Женские брюки оптом в Кургане");
        $(".header h2").text("КУПИТЬ БРЮКИ ОПТОМ В КУРГАНЕ");
        $(".costums, .blouse, .skirt, .dresses, .jackets, .cardigans, .cloak, .overalls, .coat, .clothes").hide();
    });
     $(".leftbar li:nth-child(6) a").click(function(){
        $(".jackets").show();
        $(".path h4:nth-child(3) a").text("Женские жакеты оптом в Кургане");
        $(".header h2").text("КУПИТЬ ЖАКЕТЫ ОПТОМ В КУРГАНЕ");
        $(".costums, .blouse, .skirt, .trousers, .dresses, .cardigans, .cloak, .overalls, .coat, .clothes").hide();
    });
     $(".leftbar li:nth-child(7) a").click(function(){
        $(".overalls").show();
        $(".path h4:nth-child(3) a").text("Женские комбинезоны оптом в Кургане");
        $(".header h2").text("КУПИТЬ КОМБИНЕЗОНЫ ОПТОМ В КУРГАНЕ");
        $(".costums, .blouse, .skirt, .trousers, .jackets, .cardigans, .cloak, .dresses, .coat, .clothes").hide();
    });
     $(".leftbar li:nth-child(8) a").click(function(){
        $(".cardigans").show();
        $(".path h4:nth-child(3) a").text("Женские кардиганы оптом в Кургане");
        $(".header h2").text("КУПИТЬ КАРДИГАНЫ ОПТОМ В КУРГАНЕ");
        $(".costums, .blouse, .skirt, .trousers, .jackets, .dresses, .cloak, .overalls, .coat, .clothes").hide();
    });
     $(".leftbar li:nth-child(9) a").click(function(){
        $(".cloak").show();
        $(".path h4:nth-child(3) a").text("Женские плащи оптом в Кургане");
        $(".header h2").text("КУПИТЬ ПЛАЩИ ОПТОМ В КУРГАНЕ");
    ...
    $(".leftbar li:nth-child(10) a").click(function(){
        $(".coat").show();
        $(".path h4:nth-child(3) a").text("Женские пальто оптом в Кургане");
        $(".header h2").text("КУПИТЬ ПАЛЬТО ОПТОМ В КУРГАНЕ");
        $(".dresses, .blouse, .skirt, .trousers, .jackets, .cardigans, .cloak, .overalls, .costums, .costums").hide();
    });
    $("#cth").click(function(){
        $(".clothes").show();
        $(".header h2").text("КУПИТЬ ОПТОВУЮ ОДЕЖДУ В КУРГАНЕ");
        $(".path h4:nth-child(3) a").text("Женские одежда оптом в Кургане");
