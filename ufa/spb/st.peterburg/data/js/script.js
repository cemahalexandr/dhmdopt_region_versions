$(function(){
  /*  $(".leftbar li:nth-child(1) a").click(function(){
        ...
        $(".header h2").text("КУПИТЬ ПЛАТЬЯ ОПТОМ В САНКТ-ПЕТЕРБУРГ");
    ...
    $(".leftbar li:nth-child(2) a").click(function(){
        ...
        $(".header h2").text("КУПИТЬ КОСТЮМЫ ОПТОМ В САНКТ-ПЕТЕРБУРГ");
     ...
     $(".leftbar li:nth-child(3) a").click(function(){
        ...
        $(".header h2").text("КУПИТЬ БЛУЗКИ ОПТОМ В САНКТ-ПЕТЕРБУРГ");
     ...
     $(".leftbar li:nth-child(4) a").click(function(){
        ...
        $(".header h2").text("КУПИТЬ ЮБКИ ОПТОМ В САНКТ-ПЕТЕРБУРГ");
     ...
     $(".leftbar li:nth-child(5) a").click(function(){
        ...
        $(".header h2").text("КУПИТЬ БРЮКИ ОПТОМ В САНКТ-ПЕТЕРБУРГ");
     ...
     $(".leftbar li:nth-child(6) a").click(function(){
        ...
        $(".header h2").text("КУПИТЬ ЖАКЕТЫ ОПТОМ В САНКТ-ПЕТЕРБУРГ");
     ...
     $(".leftbar li:nth-child(7) a").click(function(){
        ...
        $(".header h2").text("КУПИТЬ КОМБИНЕЗОНЫ ОПТОМ В САНКТ-ПЕТЕРБУРГ");
     ...
     $(".leftbar li:nth-child(8) a").click(function(){
        ...
        $(".header h2").text("КУПИТЬ КАРДИГАНЫ ОПТОМ В САНКТ-ПЕТЕРБУРГ");
     ...
     $(".leftbar li:nth-child(9) a").click(function(){
        ...
        $(".header h2").text("КУПИТЬ ПЛАЩИ ОПТОМ В САНКТ-ПЕТЕРБУРГ");
    ...
    $(".leftbar li:nth-child(10) a").click(function(){
        ...
        $(".header h2").text("КУПИТЬ ПАЛЬТО ОПТОМ В САНКТ-ПЕТЕРБУРГ");
        $(".dresses, .blouse, .skirt, .trousers, .jackets, .cardigans, .cloak, .overalls, .costums, .costums").hide();
    });
    $("#cth").click(function(){
        $(".clothes").show();
        $(".header h2").text("КУПИТЬ ОПТОВУЮ ОДЕЖДУ В САНКТ-ПЕТЕРБУРГ");
